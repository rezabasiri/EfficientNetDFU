...
get_ipython().system('python main.py --mode=train_and_eval     --data_dir=tfrecord     --model_name={MODEL}     --model_dir=model_dir/{MODEL}-finetune     --train_batch_size=8     --eval_batch_size=8     --num_eval_images=399     --num_train_images=1601     --num_label_classes=1     --use_tpu=false     --train_steps=50000     --steps_per_eval=500     --moving_average_decay=0     --base_learning_rate=0.01 ')
